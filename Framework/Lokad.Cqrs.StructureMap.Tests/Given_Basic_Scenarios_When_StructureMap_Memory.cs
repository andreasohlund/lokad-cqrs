...
{
    [TestFixture]
    public sealed class Given_Basic_Scenarios_When_StructureMap_Memory : Given_Basic_Scenarios
    {
        ...
        {
            config.MessagesWithHandlersFromStructureMap(ddd => ddd.WhereMessages(t => t.BaseType == GetType()));
            config.Memory(m =>
                {
