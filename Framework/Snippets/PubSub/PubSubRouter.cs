...
{
    /// <summary>
    /// This is a sample snippet of a router that does 3 things:
    /// 1. It maintains routing (publish/subscribe) map, which could be
    /// controller by special messages.
    /// 2. It routes event to subscribers using this map
    /// 3. It routes commands to a single queue.
    /// 
    /// This snippet could be expanded to support command partitioning 
    /// (entity partitioning) in a similar manner.
    /// </summary>
