...
{
    [DataContract]
    public sealed class AccountPaymentCanceled : ISesEvent
    {
        ...
        public AccountPaymentCanceled(int transactionId, decimal amount, decimal balance, string reason,
        ...
        {
            return string.Format("Cancel payment '{0}' of {1} because '{2}'. New balance {3} (tx{4})",
